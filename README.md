...
```text
├── server.py           # The Flask Backend API (Runs on localhost:5000)
├── client.py           # The Client Script (Interacts with user & server)
├── stockViewer.py      # Helper module for graph visualization logic
